...
#Reference model with only encryption 
	...
	def compare(self,output_dut,output_rm): #function to compare the outputs recieved from Reference model and DUT
...
async def first_test(dut):
	...
	elemns = 10
	fp32_inp = torch.rand(elemns, dtype=torch.float32)*10
